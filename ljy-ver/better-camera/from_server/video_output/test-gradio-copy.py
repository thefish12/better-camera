...
demo = gr.Interface(
    f,
    [gr.Image(sources=["webcam"], streaming=True, type = "filepath",every=2),gr.Number(value=1,label="people"), gr.Slider(0, 1.0, value=0.8, label="注视强度"),gr.Slider(0, 1.0, value=0.2, label="遮挡强度")],
    ["text"],
    title="正在检测看镜头和人脸遮挡",
    live=True,
#     transcribe,
